    ...
    <aside className="h-screen sticky top-0 flex flex-col items-center w-60 text-gray-400 bg-gray-900">
        ...
        >
          ...
          <defs>
            ...
            <linearGradient
              ...
              gradientUnits="userSpaceOnUse"
            >
              <stop stopColor="#47E5BC" />
              <stop offset="1" stopColor="#5C95FF" />
            </linearGradient>
          </defs>
        </svg>
      ...
      <div className="w-full px-2">
        ...
        <div className="flex flex-col items-center w-full mt-3 border-t border-gray-700">
          ...
          <Link href="/storage/manager">
            <a className="flex items-center w-full h-12 px-3 mt-2 rounded bg-gray-700 hover:bg-gray-700 text-gray-200 hover:text-gray-300">
              <svg
                xmlns="http://www.w3.org/2000/svg"
                className="h-6 w-6"
                fill="none"
