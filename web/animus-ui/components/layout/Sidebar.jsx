...
export default function Sidebar() {
  return (
    <aside className="fixed left-0 top-0 w-60 h-screen overflow-hidden text-gray-400 bg-gray-900">
      <div className="flex flex-col items-center">
        <a className="flex items-center w-full px-6 my-6" href="#">
          <svg
  ...
  return (
    <div className="flex items-center justify-center w-full h-16 mt-auto bg-gray-800 hover:bg-gray-700 hover:text-gray-50">
      <Menu as="div">
        ...
        <Menu.Items className="absolute origin-top-right mt-1 w-40 rounded-md shadow-lg bg-white ring-1 ring-black ring-opacity-5 divide-y divide-gray-100 focus:outline-none">
